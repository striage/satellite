...
func (am *AssetManager) getAsset(name string) *sprite.Sprite {
...
func mustLoadSprite(name, baseName string) *sprite.Sprite {
	img := mustLoadImage(name)
	return sprite.NewSpriteFromImage(baseName, img, 0, 0)
}
